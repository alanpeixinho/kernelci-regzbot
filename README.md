...
Regzbot was started by Thorsten Leemhuis and is available under the APGL 3.0;
see the file COPYING for details. If you think a more liberal license should be
used, let Thorsten know what you'd prefer, as for now it's still quite easy to
change the license.
